...
export interface TaxonomyIndex {
  tags: Term[]
  categories: Term[]
  pagesByTag: Map<string, CollectionEntry<"page">[]>
  pagesByCategory: Map<string, CollectionEntry<"page">[]>
}
...
export function buildTaxonomyIndex(pages: CollectionEntry<"page">[]): TaxonomyIndex {
  if (!DEV && cachedIndex) return cachedIndex

  const tagCount: Record<string, number> = {}
  const categoryCount: Record<string, number> = {}
  const pagesByTag = new Map<string, CollectionEntry<"page">[]>()
  const pagesByCategory = new Map<string, CollectionEntry<"page">[]>()
