      ...
      for (const match of matches) {
        ...
        if (isEmbed) {
          ...
          if (IMAGE_EXTS.has(ext)) {
             ...
             * TODO: mungkin akan sulit di buat. jadi sementara lupakan dulu
             *
            const isBroken = !resolvedPath
            if (isBroken)
              console.warn("- ⚠️ Internal embed not found: ", target)
