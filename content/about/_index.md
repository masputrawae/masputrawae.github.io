...
thumbnail: 'images/for-about.jpg'
description: 'Profil singkat tentang saya, perjalanan belajar otodidak, dan hal-hal yang saya sukai.'
skills:
  - name: HTML
    description: Dasar-dasar HTML sudah saya kuasai dengan baik dan sering saya gunakan untuk latihan proyek kecil.
    icon: icon--html
    level: 20
  - name: CSS/SCSS
    description: Cukup nyaman menggunakan CSS, termasuk memahami layout dan styling responsif.
    icon: icon--css
    level: 30
  - name: JavaScript
    description: Saat ini fokus utama saya. Masih dalam tahap eksplorasi tapi saya senang mencoba hal baru dengan bahasa ini.
    icon: icon--javascript
    level: 10
  - name: Python
    description: Baru mengenal dasarnya, tapi saya suka kesederhanaan dan sintaksnya yang rapi.
    icon: icon--python
    level: 10
---

<h1>Halo, saya Putra</h1>
<strong class="text-w-400 text-3xl">Dari Jawa Timur, Indonesia.</strong>
