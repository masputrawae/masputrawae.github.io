...
# --- LOAD PLACEHOLDERS ---
title_words = load_yaml("./_dummy_md/placeholders/title_words.yaml")
concepts = load_yaml("./_dummy_md/placeholders/concepts.yaml")  # File baru untuk konsep zettelkasten
tags = load_yaml("./_dummy_md/placeholders/tags.yaml")
lorem_paragraphs = load_yaml("./_dummy_md/placeholders/lorem_paragraphs.yaml")
lorem_descriptions = load_yaml("./_dummy_md/placeholders/lorem_description.yaml")
...
total_notes = 50  # Jumlah catatan zettelkasten
all_note_ids = []
